      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
              ...
              <tr>
                <td colspan="6">
                  <div class="bulk-actions align-left">
				    <a href="__URL__/add?pid=<?php echo ($pid); ?>">【新增分类】</a>
            ...
            <tbody>
			<?php if(is_array($result)): foreach($result as $key=>$vo): ?><tr id="tr_<?php echo ($vo['id']); ?>">
                <td>
                  <input type="checkbox" />
                </td>
                <td><?php echo ($vo["id"]); ?></td>
                <td><?php echo ($vo["name"]); ?></td>
                <td><a href="__URL__/index?pid=<?php echo ($vo['id']); ?>">进入下级</a></td>
                <td>Donec tortor diam</td>
                <td>
                  <!-- Icons -->
                  <a href="<?php echo U('Article_cate/add?id='.$vo['id'].'');?>" title="Edit"><img src="__PUBLIC__/images/icons/pencil.png" alt="Edit" /></a> <a href="#" onclick="del(<?php echo ($vo['id']); ?>);" title="Delete"><img src="__PUBLIC__/images/icons/cross.png" alt="Delete" /></a> <a href="#" title="Edit Meta"><img src="__PUBLIC__/images/icons/hammer_screwdriver.png" alt="Edit Meta" /></a> </td>
