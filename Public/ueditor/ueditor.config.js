...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["source","insertunorderedlist","insertorderedlist","link","preview","searchreplace","insertimage","music","snapscreen","insertvideo","date","time","map","horizontal","insertcode","bold","italic","underline","strikethrough","forecolor","backcolor","justifyleft","justifycenter","justifyright","justifyjustify","removeformat","formatmatch","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable"]]
